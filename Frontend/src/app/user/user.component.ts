...
export class UserComponent implements OnInit {
  ...
  average(data){
    ...
    // var startDate1=start.getTime();
    // var endDate1=end.getTime();
    // var average1=endDate1-startDate1;
    var diffDays = Math.round(Math.abs((start.getTime() - end.getTime())/(24*3600*1000)));

    console.log("startDate",diffDays)
    return Math.round(data.distance/diffDays);
